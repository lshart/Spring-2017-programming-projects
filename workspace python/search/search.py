...
def uniformCostSearch(problem):
    ...
    for stuff in initialNodes:
        openList.push([stuff[0],[stuff[1]], stuff[2]], stuff[2])
    ...
    while not openList.isEmpty():
        ...
        if not save[0] in closedList:
            if problem.isGoalState(save[0]):
                ...
                for stuff in newNodes:
                    if not stuff[0] in closedList:
                        openList.push([stuff[0],save[1] + [stuff[1]], save[2] + stuff[2]], save[2] + stuff[2])
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    for stuff in initialNodes:
        gPlusH = stuff[2] + heuristic(stuff[0],problem)
        openList.push([stuff[0],[stuff[1]], stuff[2]], gPlusH)
    ...
    while not openList.isEmpty():
        ...
        if not save[0] in closedList:
            if problem.isGoalState(save[0]):
                ...
                for stuff in newNodes:
                    if not stuff[0] in closedList:
                        gPlusH = stuff[2] + save[2] + heuristic(stuff[0],problem)
                        openList.push([stuff[0],save[1] + [stuff[1]], save[2] + stuff[2]], gPlusH)
